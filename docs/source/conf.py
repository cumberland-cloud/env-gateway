...
html_theme_options = {
    ...
    'base_url': 'https://cumberland-cloud.github.io/env-gateway/',
    ...
    'repo_url': 'https://github.com/cumberland-cloud/env-gateway.git',
    'repo_name': 'env-gateway',
